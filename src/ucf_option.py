...
parser.add_argument('--seed', default=9, type=int)#234
...
parser.add_argument('--max-epoch', default=9, type=int)
parser.add_argument('--model-path', default='model_ucf1.pth')
parser.add_argument('--use-checkpoint', default=False, type=bool)
parser.add_argument('--checkpoint-path', default='model/checkpoint1.pth')
